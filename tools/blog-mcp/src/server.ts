...
const SERVER_INSTRUCTIONS = [
  ...
  'blog_verify_published_url. Only blog_verify_published_url and',
  'blog_publish_report may report a live/published URL, and each does so only',
  'after confirming the Docs Deploy run for that exact commit succeeded and a',
  'direct HTTPS GET of the URL returned 200 -- never construct or state a',
  'published URL yourself outside of what these tools return.',
